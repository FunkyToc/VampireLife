execute if score Difficulty VP_Options matches 1 run function vp:systems/bloodbar/hunger/10
execute if score Difficulty VP_Options matches 1 run function vp:systems/bloodbar/poison/2

execute if score Difficulty VP_Options matches 2 run function vp:systems/bloodbar/hunger/14
execute if score Difficulty VP_Options matches 2 run function vp:systems/bloodbar/poison/2

execute if score Difficulty VP_Options matches 3 run function vp:systems/bloodbar/hunger/18
