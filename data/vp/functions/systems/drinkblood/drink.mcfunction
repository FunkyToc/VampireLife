...
execute if score @s VP_VampireLevel matches 0 if entity @s[scores={VP_DrinkLevel=100..}] positioned ^ ^ ^1 run function vp:systems/drinkblood/drink_entity
execute if score @s VP_VampireLevel matches 1 if entity @s[scores={VP_DrinkLevel=80..}] positioned ^ ^ ^1 run function vp:systems/drinkblood/drink_entity
execute if score @s VP_VampireLevel matches 2 if entity @s[scores={VP_DrinkLevel=60..}] positioned ^ ^ ^1 run function vp:systems/drinkblood/drink_entity
execute if score @s VP_VampireLevel matches 3 if entity @s[scores={VP_DrinkLevel=40..}] positioned ^ ^ ^1 run function vp:systems/drinkblood/drink_entity