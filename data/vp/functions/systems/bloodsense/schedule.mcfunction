...
# hungry vampire
execute as @a[tag=vampire,scores={VP_FoodLevel=..4},predicate=!fktool:entity/sneaking] run tag @s add hungry
execute as @a[tag=vampire,scores={VP_FoodLevel=..4},predicate=!fktool:entity/sneaking] run scoreboard players set @s VP_SneakTime 140
execute as @a[tag=vampire,scores={VP_FoodLevel=..4},predicate=!fktool:entity/sneaking] at @s run function vp:systems/bloodsense/bloodsense
execute as @a[tag=hungry] run tag @s remove hungry
